...
miniaturas = listaRedim(cargar_imagenes(b"C:\Projects\USB\Python\Mosaico\imagenes"),30,20) #default 30 y 20

Mosaico = construirMosaico(imagen, miniaturas, 200) #default 100
